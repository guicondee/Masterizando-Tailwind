...
export function InputRoot(props: InputRootProps) {
  return (
    <div
      className="flex w-full items-center gap-2 rounded-lg border border-zinc-300 px-3 py-2 shadow-sm focus-within:border-green-300 focus-within:ring-4 focus-within:ring-green-100"
      {...props}
    />
  );
}
